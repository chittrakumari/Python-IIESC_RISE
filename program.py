...
pyttsx3.speak("Welcome to this application!")
pyttsx3.speak("How can we help you?We have the following tools available")
print("We can open or execute the following for you:Notepad ,Calculator ,Chrome ,Microsoft Word ,Microsoft Excel ,Microsoft PowerPoint ,Camera ,Calendar ,Settings ,File Explorer,Paint,Apps ,Command Prompt ,Control Panel ,Microsoft Edge ")

while "exit" or "quit" not in p:
